...
import "github.com/noxworld-dev/opennox-lib/client/keybind"
...
//
// (#define DIK_ABNT_C2         0x7E    /* Numpad . on Brazilian keyboard */ - system should map this to KP_COMMA or
// something,
...
var scanCodeToKeyNum = []keybind.Key{
	...
	0x2B, //	SDL_SCANCODE_NONUSHASH = 50, // same key as before actually on some layouts, systems should map this to
	...
	0xD2, //	SDL_SCANCODE_INSERT = 73, // insert on PC, help on some Mac keyboards (but does send code 73, not 117) -
	// DIK_INSERT
	...
	0xDE, //	SDL_SCANCODE_POWER = 102, // should be a status flag, but some mac keyboards have a power key -
	// DIK_POWER
	...
	0x7B, //	SDL_SCANCODE_INTERNATIONAL5 = 139, // Japan: NFER/"don't convert kana -> kanji", left of space -
	// DIK_NOCONVERT
